...
public class MenuGrid {
    ...
    public static final Color[] colors = {Color.RED, Color.GREEN, Color.CYAN, Color.BLUE, Color.PINK, Color.MAGENTA, Color.YELLOW,
    ...
    public void updateActualColor(double x, double y) {
    ...
    private void createActualColor() {
        ...
        actualColor.setColor(Color.WHITE);
        actualColor.fill();
    }
